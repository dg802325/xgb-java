...
insert into jc_model_item(model_id,field,item_label,priority,def_value,opt_value,text_size,area_rows,area_cols,help,help_position,data_type,is_single,is_channel,is_custom,is_display,is_required,image_width,image_height,) value(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,);
