...
insert into jc_content_ext(title,short_title,author,origin,origin_url,description,media_path,media_type,title_color,is_bold,title_img,content_img,type_img,link,tpl_content,need_regenerate,tpl_mobile_content,toplevel_date,pigeonhole_date,release_date,) value(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,);
