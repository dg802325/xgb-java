...
public class SaveStNjQgothercase19SubService {

    public static StringBuffer saveEntity(StringBuffer buffer , List<StNjQgothercase19Sub> contents){
        for(StNjQgothercase19Sub content:contents){
        ...
        String qitaqingkuang = content.getQitaqingkuang ();//其他情况
    ...
    public static void writeToRestource(StringBuffer buffer){
        ...
        String studentResourcePath = new File(path, "/StNjQgothercase19Sub.txt").getAbsolutePath();
        // 保证目录一定存在
