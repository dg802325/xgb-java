...
public class SaveStNjHfgxTbService {
    ...
    public static StringBuffer saveEntity(StringBuffer buffer , List<StNjHfgxTb> contents){
        ...
        Integer yingjiaohuifei = content.getYingjiaohuifei ();//应缴会费
        Integer libiaodanwei = content.getLibiaodanwei ();//理标单位
        Integer lishudanwei = content.getLishudanwei ();//理数单位
        Integer lijiaodanwei = content.getLijiaodanwei ();//理缴单位
        Integer libiaogeren = content.getLibiaogeren ();//理标个人
        Integer lishugeren = content.getLishugeren ();//理数个人
        Integer lijiaogeren = content.getLijiaogeren ();//理缴个人
        Integer fubiaodanwei = content.getFubiaodanwei ();//副标单位
        Integer fushudanwei = content.getFushudanwei ();//副数单位
        Integer fujiaodanwei = content.getFujiaodanwei ();//副缴单位
        Integer fubiaogeren = content.getFubiaogeren ();//副标个人
        Integer fushugeren = content.getFushugeren ();//副数个人
        Integer fujiaogeren = content.getFujiaogeren ();//副缴个人
        Integer changbiaodanwei = content.getChangbiaodanwei ();//常标单位
        Integer changshudanwei = content.getChangshudanwei ();//常数单位
        Integer changjiaodanwei = content.getChangjiaodanwei ();//常缴单位
        Integer changbiaogeren = content.getChangbiaogeren ();//常标个人
        Integer changshugeren = content.getChangshugeren ();//常数个人
        Integer changjiaogeren = content.getChangjiaogeren ();//常缴个人
        Integer lishibiaodanwei = content.getLishibiaodanwei ();//理事标单位
        Integer lishishudanwei = content.getLishishudanwei ();//理事数单位
        Integer lishijiaodanwei = content.getLishijiaodanwei ();//理事缴单位
        Integer lishibiaogeren = content.getLishibiaogeren ();//理事标个人
        Integer lishishugeren = content.getLishishugeren ();//理事数个人
        Integer lishijiaogeren = content.getLishijiaogeren ();//理事缴个人
        Integer huibiaodanwei = content.getHuibiaodanwei ();//会标单位
        Integer huishudanwei = content.getHuishudanwei ();//会数单位
        Integer huijiaodanwei = content.getHuijiaodanwei ();//会缴单位
        Integer huibiaogeren = content.getHuibiaogeren ();//会标个人
        Integer huishugeren = content.getHuishugeren ();//会数个人
        Integer huijiaogeren = content.getHuijiaogeren ();//会缴个人
        Integer zichanzonge = content.getZichanzonge ();//资产总额
        Integer chanzhizonge = content.getChanzhizonge ();//产值总额
        Integer danweichanzhi = content.getDanweichanzhi ();//单位产值
        String huiyuanbili = content.getHuiyuanbili ();//会员比例
        Integer shitishuliang = content.getShitishuliang ();//实体数量
        Integer shitichanzhi = content.getShitichanzhi ();//实体产值
        Integer xinarenshu = content.getXinarenshu ();//吸纳人数
        String jianyishuliang = content.getJianyishuliang ();//建议数量
        Integer mujizijin = content.getMujizijin ();//募集资金
        Integer huijirenqun = content.getHuijirenqun ();//惠及人群
        Integer jiuyegangwei = content.getJiuyegangwei ();//就业岗位
        Integer xinzengshouru = content.getXinzengshouru ();//新增收入
