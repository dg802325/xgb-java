...
public class SaveMfNianjianJbxxService {
    ...
    public static StringBuffer saveEntity(StringBuffer buffer , List<MfNianjianJbxx> contents){
        ...
        Integer kaibanzijin = content.getKaibanzijin ();//开办资金
        ...
        Integer jineyi = content.getJineyi ();//金额一
        String chuzizheer = content.getChuzizheer ();//出资者二
        Integer jineer = content.getJineer ();//金额二
        String chuzizhesan = content.getChuzizhesan ();//出资者三
        Integer jinesan = content.getJinesan ();//金额三
        String chuzizhesi = content.getChuzizhesi ();//出资者四
        Integer jinesi = content.getJinesi ();//金额四
        String chuzizhewu = content.getChuzizhewu ();//出资者五
        Integer jinewu = content.getJinewu ();//金额五
        ...
        Integer gongyizhichu = content.getGongyizhichu ();//null
        ...
        Integer mujizijinshu = content.getMujizijinshu ();//null
