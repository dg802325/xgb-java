...
public class BbiChinaDivision {
    ...
    public BbiChinaDivision(String id, String divisionName, String parentId, String divisionCode, String regionId, String postCode, Boolean isForbidden, Boolean isDel, String creatorId, Date createTime, String modifierId, Date modifyTime, String hlbDivisionCode) {
        this.id = id;
