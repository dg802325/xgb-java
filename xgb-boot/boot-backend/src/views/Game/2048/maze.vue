<template>
    ...
    <div class="wrapper" >
        <h1 style="font-size: 80px; margin-top: 30px; margin-left: -200px;">2048</h1>
            ...
            <div>
                <div style="margin-left: 50px; display: block;">
                    ...
                    <div style="margin-top: 30px;">
                        <div>
                            <span style="font-size: 30px;" >当前： </span>
                            <span style="font-size: 30px;">{{score}}</span>
                        </div>
                        <div style="margin-top: 20px;">
                            <span style="font-size: 30px;">最高： </span>
                            <span style="font-size: 30px;">{{bestScore}}</span>
                        </div>
                    </div>
                </div>
                <div class="btn btn-mg" style="margin-left: 50px;margin-top: 50px;" @click="newGame">开始游戏</div>
            </div>
        </div>
    </div>
</template>
