    ...
    export default {
        ...
        methods: {
            ...
            async saveUserPermissions() {
                ...
                // let name ='82008BCFBE39459CBF6FC24508737F2A'
                let data = {
                    userId: this.userId,
                    // userId:name,
            ...
            async getPermissions() {
                let res = await this.$get("/admin/getSuppliePermission")
                console.log(res)
                let map = {};
                let permission = [];
                res.forEach(item => {
                ...
                for (let key in map) {
                    if (map[key].parentId) {
                        ...
                        console.log(this.defaultCkeckId.includes(map[key].id))
                        console.log(map[map[key].parentId])
