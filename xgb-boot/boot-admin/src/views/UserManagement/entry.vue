        ...
        <div class="container">
            ...
            <div class="table_border">
                <el-table
                        ...
                        border
                        style="width: 100%">
                    <el-table-column prop="userAccount" align="center" label="成员账号" width="135px;"></el-table-column>
                    <el-table-column prop="userName" align="center" label="姓名" width="135px"></el-table-column>
                    <el-table-column prop="roleName" align="center" label="所属岗位" width="135px;"></el-table-column>
                    <el-table-column prop="departmentName" align="center" label="所属部门" width="135px;"></el-table-column>
                    <el-table-column prop="createTime" align="center" label="添加时间" width="160px"></el-table-column>
                    <el-table-column prop="lastLogin" align="center" label="最后登录" width="160px">
                    </el-table-column>
                    <el-table-column prop="isForbidden" align="center" label="是否启用" width="80px">
    ...
    export default {
        ...
        methods: {
            async switchChange(item) {
                ...
                let res = await this.$post('/supplier/setErpUserEnable', data)
                if (res.code == 200) {
            ...
            async requestSearch(page) {
                ...
                let res = await this.$get("/supplier/getErpUserRoleForPage", data)
            ...
            async delUser() {
                let res = await this.$post("/supplier/remove_erpUserRole", {userRoleId: this.item.userRoleId})
                if (res.code == 200) {
                    this.$message.success(res.message);
