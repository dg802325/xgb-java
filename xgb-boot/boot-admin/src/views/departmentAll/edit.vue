<template>
    <el-dialog title="编辑部门"  width="600px" :visible.sync="editVisible" :before-close="closeEvent">
        <el-form ref="form"  label-width="100px" style="height: 180px;padding-left: 35px">
            <el-form-item label="部门名称:" required>
                <el-input v-model="editItem.departmentName" size="1" style="width: 358px"></el-input>
            </el-form-item>
        </el-form>
    ...
    export default {
        ...
        methods: {
            ...
            async editDepartment() {
                let data = {
                    id:this.editItem.id,
                    departmentName: this.editItem.departmentName,
