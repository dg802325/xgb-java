    ...
    export default {
        ...
        methods: {
            ...
            async getResource(){
                ...
                let res = await this.$get('/admin/getSkuInfoAll',data)
                let urlList = res.SkuResources
                urlList.forEach(item=>{
                    this.uploadFileList.push(item.resourcesUrl)
                })
                this.skuExplain = res.Sku.skuExplain
            ...
            async handleImageAdded(file, Editor, cursorLocation, resetUploader){
                ...
                let res = await this.$fileUpload("/admin/upload/pictureUrl", formData);
                let url = res.fileUrl
                Editor.insertText(cursorLocation, ' ', '', true);
            ...
            async retreat(){
                this.$router.push('/sku/selectTable/backEditSkuInfo/'+this.parentId+'/'+this.spuId+'/'+this.id);
            }
