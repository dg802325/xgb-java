...
<!--                            <el-input  v-model="specification" size="1" style="width: 250px;height:40px"></el-input>-->
<!--                        </el-form-item>-->
        ...
        methods: {
            ...
            async saveCategory(){
                ...
                if(res.code==200){
                    ...
                    this.$router.push('/sku/selectTable/editResource/'+this.parentId+'/'+this.spuId+'/'+this.id);
                }
            },
            //查询当前商品分类
            async getCategory(){
            ...
            retreats(){
                // this.$router.push('/sku/backEditClass/' + this.parentId)
            }
        },
    }
