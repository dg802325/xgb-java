...
<!--                    <el-button class="el-button_1" @click="addDepartment" >添加部门</el-button>-->
            ...
            <div class="table_border">
                <el-table
                        ...
                        border
                        style="width: 100%">
                    <el-table-column prop="departmentName" align="center" label="部门名称" width="200px;"></el-table-column>
                    <el-table-column prop="roleName" align="center" label="岗位" width="320px"></el-table-column>
                    <el-table-column prop="userCount" align="center" label="成员数量" width="100px">
                    </el-table-column>
                    <el-table-column prop="createTime" align="center" label="添加时间" width="180px;"></el-table-column>
                    <el-table-column prop="isEnable" align="center" label="是否启用" width="100px">
    ...
    export default {
        ...
        methods: {
            async switchChange(item) {
                ...
                let res = await this.$post('/supplier/setIsForbidden', data)
                if (res.code == 200) {
            ...
            async requestSearch(page) {
                ...
                let res = await this.$get("/supplier/getErpRoleForPage", data)
            ...
            async deleteDepartment() {
                ...
                let res = await this.$post("/supplier/remove_erpRole", data)
                if (res.code == 200) {
                    this.$message.success(res.message)
