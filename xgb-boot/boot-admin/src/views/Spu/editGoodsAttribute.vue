    ...
    export default {
        ...
        methods: {
            ...
            async saveGoods(){
                ...
                // let resr = await this.$get("/admin/getResourceById", {id:this.skuId});
                // console.log(resr)

                // let resa = await this.$get("/admin/getSkuShop", {id:this.skuId});
            ...
            async retreat(){
                ...
                this.$router.push('/sku/addGoods/editAddGoodInformation/'+this.parentId + '/'+this.skuId)
            }
        }
    }
</script>
