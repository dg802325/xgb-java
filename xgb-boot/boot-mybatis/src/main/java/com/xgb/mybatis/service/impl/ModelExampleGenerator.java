...
public class ModelExampleGenerator extends CodeGeneratorManager implements CodeGenerator {
    ...
    public String codeEntityExample(List<TableInformation> tableInformation){
        ...
        for (TableInformation ti :tableInformation){
            ...
            stringBuilder.append(space).append(space).append(space).append("(Criteria)this;").append("\n");
            ...
            stringBuilder.append(space).append(space).append(space).append("addCriterion(\"").append(ti.getColumnName()).append(" in\", value, \"id\");").append("\n");
            stringBuilder.append(space).append(space).append(space).append("(Criteria)this;").append("\n");
            stringBuilder.append(space).append(space).append("}").append("\n");
            stringBuilder.append("\n");
            //NotIn
            ...
            stringBuilder.append(space).append(space).append(space).append("addCriterion(\"").append(ti.getColumnName()).append(" not in\", value, \"id\");").append("\n");
            stringBuilder.append(space).append(space).append(space).append("(Criteria)this;").append("\n");
            stringBuilder.append(space).append(space).append("}").append("\n");
            stringBuilder.append("\n");
            //Between
