...
public class StringUtils {
    ...
    public static String builderString(TableColumnInfo tableColumnInfo){
        if("NVARCHAR2".equals(tableColumnInfo.getTypeName())||"VARCHAR".equals(tableColumnInfo.getTypeName())||"VARCHAR2".equals(tableColumnInfo.getTypeName())){
            return "String";
            ...
            return "BigDecimal";
        }else if("SMALLINT".equals(tableColumnInfo.getTypeName())||"BIGINT UNSIGNED".equals(tableColumnInfo.getTypeName())||"INT".equals(tableColumnInfo.getTypeName())||"INTEGER".equals(tableColumnInfo.getTypeName())||"NUMBER".equals(tableColumnInfo.getTypeName())||"BIGINT".equals(tableColumnInfo.getTypeName())){
            return "Integer";
        }
        return null;
    }
