...
public class GoogleAuthen {
    ...
    static String savedSecret = "I3NIBS5ZRTKXCQU2";
    public static void  main(String[] args){
        String secret = GoogleAuthen.generateSecretKey();
        /*String url = GoogleAuthenticator.getQRBarcodeURL("lg003x", "163.com", secret);
        /*System.out.println("Please register " + url);*/
        System.out.println("Secret key is " + secret);
        long code = 810533;
        long t = System.currentTimeMillis();
        GoogleAuthen ga = new GoogleAuthen();
