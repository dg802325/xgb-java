...
public class JjhnjYfkxSub {
    ...
    public JjhnjYfkxSub(Long id, String instanceid, String organizationid, Short status, Long masterid, String xiangmu, BigDecimal nianchuyue, BigDecimal zengjiae, BigDecimal jianshaoe, BigDecimal nianmoyue, String kehu) {
        this.id = id;
