...
public class SaveStNjJbgyhdService {

    public static StringBuffer saveEntity(StringBuffer buffer , List<StNjJbgyhd> contents){
        for (StNjJbgyhd content : contents) {
    ...
    public static void writeToRestource(StringBuffer buffer){
        ...
        String studentResourcePath = new File(path, "/StNjJbgyhd.txt").getAbsolutePath();
        // 保证目录一定存在
