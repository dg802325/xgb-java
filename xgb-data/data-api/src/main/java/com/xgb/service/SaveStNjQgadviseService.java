...
public class SaveStNjQgadviseService {

    public static StringBuffer saveEntity(StringBuffer buffer , List<StNjQgadvise> contents){
        for (StNjQgadvise content : contents) {
            ...
            String yijian1 = content.getYijian1 ();//意见1
            String yijian2 = content.getYijian2 ();//意见2
            ...
            buffer.append(yijian1+"|");
            buffer.append(yijian2+"|");
    ...
    public static void writeToRestource(StringBuffer buffer){
        ...
        String studentResourcePath = new File(path, "/StNjQgadvise.txt").getAbsolutePath();
        // 保证目录一定存在
