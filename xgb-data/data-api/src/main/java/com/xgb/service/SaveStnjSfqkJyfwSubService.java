...
public class SaveStnjSfqkJyfwSubService {

    public static StringBuffer saveEntity(StringBuffer buffer , List<StnjSfqkJyfwSub> contents){
        for (StnjSfqkJyfwSub content : contents) {
            ...
            String shoufeiyiju = content.getShoufeiyiju ();//收费依据
            String shoufeibiaozhun = content.getShoufeibiaozhun ();//收费标准
            String shiyongpiaoju = content.getShiyongpiaoju ();//使用票据
            String seq = content.getSeq ();//序号
            String bili = content.getBili ();//所占比例
            ...
            String leixing = content.getLeixing ();//null
            String didian = content.getDidian ();//null
            ...
            buffer.append(shoufeiyiju+"|");
            buffer.append(shoufeibiaozhun+"|");
            buffer.append(shiyongpiaoju+"|");
            buffer.append(seq+"|");
            buffer.append(bili+"|");
    ...
    public static void writeToRestource(StringBuffer buffer){
        ...
        String studentResourcePath = new File(path, "/StnjSfqkJyfwSub.txt").getAbsolutePath();
        // 保证目录一定存在
