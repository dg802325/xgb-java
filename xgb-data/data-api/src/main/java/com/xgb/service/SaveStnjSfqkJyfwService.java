...
public class SaveStnjSfqkJyfwService {

    public static StringBuffer saveEntity(StringBuffer buffer , List<StnjSfqkJyfw> contents){
        for (StnjSfqkJyfw content : contents) {
    ...
    public static void writeToRestource(StringBuffer buffer){
        ...
        String studentResourcePath = new File(path, "/StnjSfqkJyfw.txt").getAbsolutePath();
        // 保证目录一定存在
