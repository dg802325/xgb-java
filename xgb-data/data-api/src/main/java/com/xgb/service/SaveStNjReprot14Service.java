...
public class SaveStNjReprot14Service {

    public static StringBuffer saveEntity(StringBuffer buffer , List<StNjReprot14> contents){
        for (StNjReprot14 content : contents) {
    ...
    public static void writeToRestource(StringBuffer buffer){
        ...
        String studentResourcePath = new File(path, "/StNjReprot14.txt").getAbsolutePath();
        // 保证目录一定存在
