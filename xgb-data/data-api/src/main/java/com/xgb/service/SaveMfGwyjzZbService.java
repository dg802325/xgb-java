...
public class SaveMfGwyjzZbService {

    public static StringBuffer saveEntity(StringBuffer buffer , List<MfGwyjzZb> contents){
        for (MfGwyjzZb content : contents) {
            ...
            String shetuanzhiwu = content.getShetuanzhiwu ();//null
    ...
    public static void writeToRestource(StringBuffer buffer){
        ...
        String studentResourcePath = new File(path, "/MfGwyjzZb.txt").getAbsolutePath();
        // 保证目录一定存在
