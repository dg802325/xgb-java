...
public class SaveStNjGjhyService {

    public static StringBuffer saveEntity(StringBuffer buffer , List<StNjGjhy> contents){
        for (StNjGjhy content : contents) {
    ...
    public static void writeToRestource(StringBuffer buffer){
        ...
        String studentResourcePath = new File(path, "/StNjGjhy.txt").getAbsolutePath();
        // 保证目录一定存在
