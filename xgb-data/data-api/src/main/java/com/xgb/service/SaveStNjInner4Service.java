...
public class SaveStNjInner4Service {
    ...
    public static StringBuffer saveEntity(StringBuffer buffer , List<StNjInner4> contents){
        ...
        Object guoshui = content.getGuoshui ();//国税
        Object dishui = content.getDishui ();//地税
        Object weidengji = content.getWeidengji ();//未登记
        Object yinqianshouju = content.getYinqianshouju ();//银钱收据
        Object huifeishouju = content.getHuifeishouju ();//会费收据
        Object juanzengshouju = content.getJuanzengshouju ();//捐赠收据
        Object shuiwufapiao = content.getShuiwufapiao ();//税务发票
        Object qitapiaoju = content.getQitapiaoju ();//其他票据
        Object niandu = content.getNiandu ();//年度
        ...
        BigDecimal zhuanzhigongzi = content.getZhuanzhigongzi ();//专职工作人员平均工资
