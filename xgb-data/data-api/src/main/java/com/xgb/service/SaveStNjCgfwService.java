...
public class SaveStNjCgfwService {

    public static StringBuffer saveEntity(StringBuffer buffer , List<StNjCgfw> contents){
        for (StNjCgfw content : contents) {
    ...
    public static void writeToRestource(StringBuffer buffer){
        ...
        String studentResourcePath = new File(path, "/StNjCgfw.txt").getAbsolutePath();
        // 保证目录一定存在
