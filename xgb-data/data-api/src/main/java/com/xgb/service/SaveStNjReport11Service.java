...
public class SaveStNjReport11Service {

    public static StringBuffer saveEntity(StringBuffer buffer , List<StNjReport11> contents){
        for (StNjReport11 content : contents) {
            ...
            String xinshejigou = content.getXinshejigou ();//新设立办事机构
            String xinshebanli = content.getXinshebanli ();//已办理设立备案手续
            String chexiaojigou = content.getChexiaojigou ();//撤销办事机构
            String chexiaobanli = content.getChexiaobanli ();//已办理撤销备案手续
            String zhusuo28 = content.getZhusuo28 ();//住所28
            ...
            buffer.append(xinshejigou+"|");
            buffer.append(xinshebanli+"|");
            buffer.append(chexiaojigou+"|");
            buffer.append(chexiaobanli+"|");
            buffer.append(zhusuo28+"|");
    ...
    public static void writeToRestource(StringBuffer buffer){
        ...
        String studentResourcePath = new File(path, "/StNjReport11.txt").getAbsolutePath();
        // 保证目录一定存在
