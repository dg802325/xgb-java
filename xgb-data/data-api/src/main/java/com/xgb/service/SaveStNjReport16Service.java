...
public class SaveStNjReport16Service {

    public static StringBuffer saveEntity(StringBuffer buffer , List<StNjReport16> contents){
        for (StNjReport16 content : contents) {
    ...
    public static void writeToRestource(StringBuffer buffer){
        ...
        String studentResourcePath = new File(path, "/StNjReport16.txt").getAbsolutePath();
        // 保证目录一定存在
