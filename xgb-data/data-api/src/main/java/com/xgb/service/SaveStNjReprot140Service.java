...
public class SaveStNjReprot140Service {

    public static StringBuffer saveEntity(StringBuffer buffer , List<StNjReprot140> contents){
        for (StNjReprot140 content : contents) {
    ...
    public static void writeToRestource(StringBuffer buffer){
        ...
        String studentResourcePath = new File(path, "/StNjReprot140.txt").getAbsolutePath();
        // 保证目录一定存在
