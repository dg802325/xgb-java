...
public class NewStSaveController {
    ...
    public String insert(String zzmc,String year) {
        ...
        if(MyTools.isNotEmpty(year)){
            criteria.andPropertyEEqualTo(year);
        }
        if(MyTools.isNotEmpty(zzmc)){
            criteria.andOrgnameEqualTo(zzmc);
        }
...
//                }
    ...
    public void saveSt(FormConsultationCase formConsultationCase){
        //获得旧系统流程唯一id
        String instanceid = formConsultationCase.getInstanceid();
        //查询旧系统组织机构代码
        MjzzUserExample mjzzUserExample = new MjzzUserExample();
        mjzzUserExample.createCriteria().andIdEqualTo(formConsultationCase.getProposeid());
        List<MjzzUser> mjzzUsers = oldService.selectByExample(mjzzUserExample);
        if (MyTools.isNotEmpty(mjzzUsers)){
            //根据信用代码查询新系统用户id
            Content202Entity content202Entity = NewJcShzzDetailService.selectByXinYongDaima(mjzzUsers.get(0).getXinyongdaima());
            ...
            if(MyTools.isNotEmpty(userId)){
                ...
                if(MyTools.isNotEmpty(jcContent207)){
                    ...
                    //存2130表
                    save2130(userId,formConsultationCase,jcContent213.getContentId());
                    save2131(userId,formConsultationCase,jcContent213.getContentId());
                    save2142(userId,formConsultationCase,jcContent214.getContentId());
                    save2143(userId,formConsultationCase,jcContent214.getContentId());
                    save2182(userId,formConsultationCase,jcContent217.getContentId());
                    save2183(userId,formConsultationCase,jcContent217.getContentId());
                    save2185(userId,formConsultationCase,jcContent216.getContentId());
                    save2186(userId,formConsultationCase,jcContent216.getContentId());
                    save2187(userId,formConsultationCase,jcContent216.getContentId());
                    save2188(userId,formConsultationCase,jcContent216.getContentId());
                    save2190(userId,formConsultationCase,jcContent215.getContentId());
                    save2191(userId,formConsultationCase,jcContent215.getContentId());
                    save2192(userId,formConsultationCase,jcContent215.getContentId());
                    save2193(userId,formConsultationCase,jcContent215.getContentId());
                    save2814(userId,formConsultationCase,jcContent216.getContentId());
                    save2181(userId,formConsultationCase,jcContent218.getContentId());
                    save2197(userId,formConsultationCase,jcContent219.getContentId());
                    save2198(userId,formConsultationCase,jcContent219.getContentId());
