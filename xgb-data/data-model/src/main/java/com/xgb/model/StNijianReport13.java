...
public class StNijianReport13 {
    ...
    public StNijianReport13(Long id, String instanceid, String organizationid, Short status, String huodongzhaiyao, String tjnjjieguo1, String tjnjjieguo2, String tjnjyijian1, String tjnjyijian2, String tjnjxingming1, String tjnjxingming2, Date tjnjshijian1, Date tjnjshijian2) {
        this.id = id;
        this.instanceid = instanceid;
        this.organizationid = organizationid;
        this.status = status;
        this.huodongzhaiyao = huodongzhaiyao;
    ...
    public String getHuodongzhaiyao() {
        return huodongzhaiyao;
    }

    public void setHuodongzhaiyao(String huodongzhaiyao) {
        this.huodongzhaiyao = huodongzhaiyao == null ? null : huodongzhaiyao.trim();
    }
