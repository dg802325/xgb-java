...
public class MfGwyJzTb {
    ...
    public MfGwyJzTb(Long id, String instanceid, String organizationid, Short status, String danweimingcheng, String qianzi, Date tianbiaoshijian) {
        this.id = id;
