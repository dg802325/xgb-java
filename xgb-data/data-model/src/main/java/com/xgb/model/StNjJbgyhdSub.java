...
public class StNjJbgyhdSub {
    ...
    public StNjJbgyhdSub(Long id, String instanceid, String organizationid, Short status, Long masterid, String shisidiyu, String shijian, String huodongmingcheng, String zhichu, String fangshi, String lingyu, String dueixiang, String tjnjjieguo1, String tjnjjieguo2, String tjnjyijian1, String tjnjyijian2, String tjnjxingming1, String tjnjxingming2, Date tjnjshijian1, Date tjnjshijian2) {
        this.id = id;
        this.instanceid = instanceid;
        this.organizationid = organizationid;
        this.status = status;
        this.masterid = masterid;
        this.shisidiyu = shisidiyu;
        this.shijian = shijian;
        this.huodongmingcheng = huodongmingcheng;
        this.zhichu = zhichu;
        this.fangshi = fangshi;
        this.lingyu = lingyu;
        this.dueixiang = dueixiang;
    ...
    public String getShisidiyu() {
        return shisidiyu;
    }

    public void setShisidiyu(String shisidiyu) {
        this.shisidiyu = shisidiyu == null ? null : shisidiyu.trim();
    }
    ...
    public void setZhichu(String zhichu) {
        this.zhichu = zhichu == null ? null : zhichu.trim();
    }
    ...
    public void setFangshi(String fangshi) {
        this.fangshi = fangshi == null ? null : fangshi.trim();
    }
    ...
    public String getDueixiang() {
        return dueixiang;
    }

    public void setDueixiang(String dueixiang) {
        this.dueixiang = dueixiang == null ? null : dueixiang.trim();
    }
