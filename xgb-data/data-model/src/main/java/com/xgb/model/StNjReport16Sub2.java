...
public class StNjReport16Sub2 {
    ...
    private Date huiyikaishishijian;

    private String zhubandanweimingcheng;

    private String wofangjingfeilaiyuan;

    private String wofangfayanzhuti;

    private Date huiyijieshushijian;
    ...
    public StNjReport16Sub2(Long id, String instanceid, String organizationid, Short status, Long masterid, String xuhao, String huiyididian, String huiyileixing, String huiyimingcheng, Date huiyikaishishijian, String zhubandanweimingcheng, String wofangjingfeilaiyuan, String wofangfayanzhuti, Date huiyijieshushijian, String tjnjjieguo1, String tjnjjieguo2, String tjnjyijian1, String tjnjyijian2, String tjnjxingming1, String tjnjxingming2, Date tjnjshijian1, Date tjnjshijian2) {
        this.id = id;
        ...
        this.huiyikaishishijian = huiyikaishishijian;
        this.zhubandanweimingcheng = zhubandanweimingcheng;
        this.wofangjingfeilaiyuan = wofangjingfeilaiyuan;
        this.wofangfayanzhuti = wofangfayanzhuti;
        this.huiyijieshushijian = huiyijieshushijian;
    ...
    public void setHuiyididian(String huiyididian) {
        this.huiyididian = huiyididian == null ? null : huiyididian.trim();
    }
    ...
    public void setHuiyileixing(String huiyileixing) {
        this.huiyileixing = huiyileixing == null ? null : huiyileixing.trim();
    }
    ...
    public void setHuiyimingcheng(String huiyimingcheng) {
        this.huiyimingcheng = huiyimingcheng == null ? null : huiyimingcheng.trim();
    }

    public Date getHuiyikaishishijian() {
        return huiyikaishishijian;
    }

    public void setHuiyikaishishijian(Date huiyikaishishijian) {
        this.huiyikaishishijian = huiyikaishishijian;
    }

    public String getZhubandanweimingcheng() {
        return zhubandanweimingcheng;
    }

    public void setZhubandanweimingcheng(String zhubandanweimingcheng) {
        this.zhubandanweimingcheng = zhubandanweimingcheng == null ? null : zhubandanweimingcheng.trim();
    }

    public String getWofangjingfeilaiyuan() {
        return wofangjingfeilaiyuan;
    }

    public void setWofangjingfeilaiyuan(String wofangjingfeilaiyuan) {
        this.wofangjingfeilaiyuan = wofangjingfeilaiyuan == null ? null : wofangjingfeilaiyuan.trim();
    }

    public String getWofangfayanzhuti() {
        return wofangfayanzhuti;
    }

    public void setWofangfayanzhuti(String wofangfayanzhuti) {
        this.wofangfayanzhuti = wofangfayanzhuti == null ? null : wofangfayanzhuti.trim();
    }

    public Date getHuiyijieshushijian() {
        return huiyijieshushijian;
    }

    public void setHuiyijieshushijian(Date huiyijieshushijian) {
        this.huiyijieshushijian = huiyijieshushijian;
    }
